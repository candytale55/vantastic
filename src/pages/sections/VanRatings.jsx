// Van ratings section: renders user reviews and the average score, reusable
// for the mobile Outlet view and the desktop two-column layout.
import { useOutletContext } from 'react-router-dom'

export function VanRatingsContent({ ratings }) {
...
export default function VanRatings() {
  ...
  return <VanRatingsContent ratings={ratings} />
}
