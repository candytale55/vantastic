...
Although the site is in Spanish, I prefer this conversation to be in English.   Please take your time and let's start with Stage 1.  Eplain the reasons why we must change the current structure and generate the best option for the user experience. 
